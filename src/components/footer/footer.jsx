          ...
          <figure className="w-full flex justify-center  items-center ">
           ...
           <section className={`px-16 flex justify-between items-center flex-wrap py-8 ${isDarkMode ? 'copyright-light' : 'copyright-dark'}`}>
               ...
               <ul className="flex  mt-4 max-sm:justify-center m">
                   <li className="mx-5">
                       <Link href="https://www.facebook.com/Your-energy-is-infinite-225111464293363/?ref=br_rs" target='_blank'>
                           <span    className="w-10  h-10 fill-current  text-[#3B5999]">
                   ...
                   <li className="mx-5">
                       <Link href="https://www.instagram.com/stjarnhjarta/" target="_blank">
                           <span  className="w-10 h-10 fill-current text-[#E4405F]">
                               <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor"
