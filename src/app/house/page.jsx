        ...
        <>
            <section className="bgHouse flex items-center ">
                <div className="w-full px-16 md:w-[700px] ms-0 md:ms-24">
                    ...
                    <p className="text-[18px] mt-4">It's possible to reset the energy in your house! Find out how!</p>
            ...
            <article className="flex flex-wrap items-center justify-between px-10 md:px-16 mt-12">
                ...
                <div className="w-[750px]  ">
                    ...
                    <p className='leading-8 mt-4 '>
                        ...
                        Do you ever get that feeling when things are out of sorts in your home?  It’s nothing you can put your finger on, it’s just uncomfortable and your pets are acting nervous and out of character.

                        Have you ever gotten the chills because you felt that there was someone in the room but there was nobody there? Or, had the feeling like you’re being watched?

                        You could have a ghost in your house and sometimes these ghosts (or entities) can manipulate the energy so that you actually feel their restless presence.
                        ...
                        Anette has walked the battle fields in the Fredericksburg area, helping ghosts who were stuck to move on. She also helped a young couple to clear their grandfather’s house which would not sell because
                        the ghost of the grandfather did not want the house to sell. Shortly after her work, the house sold.
                    </p>
                </div>
            </article>
