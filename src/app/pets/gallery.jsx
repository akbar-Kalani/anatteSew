  ...
  return (
    <section className='py-3 px-16'>
      <ul class="img-list flex flex-wrap">
       ...
       <p className='my-5 first-letter:text-4xl first-letter:font-semibold text-lg'>Anette has the gift of telepathically communicating with animals and they show her, using pictures, how she can help them to heal.
...
Anette’s neighbor’s dog stopped eating and drinking and was lying in the forest to die. The neighbor asked Anette for help. She intuitively communicated with the dog who told her, that he was not going to go through another change of owner. Anette promised the dog that she would talk to the owner and asked the dog to drink some water from the puddle in a rock to get some strength to walk back down to his house. <br />
 <br />
Anette talked to the owner and when she heard the reason he wanted to die, she decided that he would go with her. The dog wagged his tail and went to the kitchen to eat and drink water. He decided to live and was his happy self again. <br /><br />

On another occasion, Anette’s daughter called and asks for healing for her riding teacher's horse Shadon, who was three years old. He had volvulus, the vet looked at him and said he had to be operated. The owner and horse were on their way to a vet clinic, a five-hour drive. <br />
